...
<html lang="en">
   ...
   <body>
      <!-- header -->
      <div class="headerw3l" style="width: 1200px;">
...
<div class="container-fluid">
    <div class="col-md-1"></div>
		...
		<th  style=" color:black;text-align: center;border: 1px solid black;">password</th>
                <th  style=" color:black;text-align: center;border: 1px solid black;">confirm_password</th>
		...
		print '<td style=" color:black;border: 1px solid black;">'.$row['password'].'</td>';
                print '<td style=" color:black;border: 1px solid black;">'.$row['confirm_password'].'</td>';
    ...
    <div class="col-md-1"></div>
      ...
      <div class="copy-right wthree" style="margin-top:180px;width: 1200px;">
         <div class="container">
