<html>
    <head>
      <title>Facutly View Student Assignment </title>
   ...
   <body>
      ...
      <!-- //header -->
	        ...
	        <div class="row">
                    <h1 style="margin-bottom:20px;margin-top: 20px;"><center>Student Submitted Assignment</center></h1>
				...
				<th  style=" color:black;text-align: center;border: 1px solid black;"> Download</th>
							 ...
							 <?php
							 include("config.php");
							 $query = mysqli_query($connection, "Select * from stuassign ");
							 ...
							 print "<td ><a href='studentsassignment/".$row["File_Upload"]."' download>Download file</a></td>"; 
